...
namespace WinFormsApp3
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\satvi\OneDrive\Desktop\training_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Content",outputColumnName:@"Content")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=5627,MinimumExampleCountPerLeaf=20,LearningRate=0.00594659067329816,LabelColumnName=@"Label",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.872224303702997,FeatureFraction=0.99999999,L1Regularization=1.3849347835958E-07,L2Regularization=0.999999776672986},MaximumBinCountPerFeature=248}))      
