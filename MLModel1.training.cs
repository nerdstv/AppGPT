...
namespace WinFormsApp3
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\satvi\OneDrive\Desktop\NITROAD\training_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Content",outputColumnName:@"Content")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=206,MinimumExampleCountPerLeaf=20,NumberOfTrees=23,MaximumBinCountPerFeature=592,FeatureFraction=0.861219683551271,LearningRate=0.999999776672986,LabelColumnName=@"Label",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Label"))      
